...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_Page2.default, null), document.getElementById('wrapper'));
	...
	var Button = function (_React$Component) {
	  ...
	  _createClass(Button, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        { className: "button", onClick: this.click.bind(this) },
	        this.state.times,
	        " times"
	      );
	    }
